...
(If someone created single photons and send it, this $D_{M2}$ would click on wrong times or don't click at all.)

\item [Step 5] Bob reveals the times that $D_B$ fired, and they use those as key.

\item [Step 6] They calculate QBER, check the number of the detections for every detector and if this two properties are within the expected they declared they run error correction and privacy amplification.
