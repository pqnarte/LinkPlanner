...
\begin{figure}[H]
	\centering
	\textbf{A Raised-Cosine Signal (roll-off=0.9) At the Transmitter Output}
	\begin{subfigure}{.5\textwidth}
		\centering
...
\begin{figure}[H]
	\centering
	\textbf{A Raised-Cosine Signal (roll-off=0.9) with Matched Filtering}
...
\begin{figure}[H]
	...
	\textbf{A Root-Raised-Cosine Signal (roll-off=0.9) with Matched Filtering}
	\begin{minipage}{\linewidth}
		\centering
	\begin{subfigure}{.45\textwidth}
		\centering
...
\begin{figure}[H]
		...
		\centering
	\textbf{A Raised-Cosine Signal (roll-off=0.3) with Matched Filtering}
	\begin{minipage}{\linewidth}
		\centering
	\begin{subfigure}{.45\textwidth}
		\centering
...
\begin{figure}[H]
		\centering
	\textbf{A Root-Raised-Cosine Signal (roll-off=0.3) with Matched Filtering}
	\begin{minipage}{\linewidth}
		\centering
	\begin{subfigure}{.45\textwidth}
		\centering
...
\begin{figure}[H]
		\centering
	\textbf{Without filter at the receptor, SNR = }
	\begin{minipage}{\linewidth}
		\centering
	\begin{subfigure}{.45\textwidth}
		\centering
...
\begin{figure}[H]
	\centering
\textbf{Root-Raised-Cosine Filter at the Receptor (roll-off=0.9) with Matched Filtering}
\begin{minipage}{\linewidth}
	\centering
	\begin{subfigure}{.45\textwidth}
		\centering
