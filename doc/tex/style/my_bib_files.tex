...
\ifdefined\quantum      \addbibresource{./sdf/quantum_random_number_generator/quantum_random_number_generator.bib}\fi
...
\ifdefined\cv           \addbibresource{./sdf/cv_system/cv_system.bib}\fi
