...
class PulseShaper : public Filter{
...
public:
	...
	/* Methods */
	PulseShaper() :Filter(){};
	PulseShaper(vector<Signal *> &InputSig, vector<Signal *> OutputSig) :Filter(InputSig, OutputSig){};
	...
	void setFilterDomain(string fDomain) { filterDomainType = fDomain; };
	string getFilterDomain() { return filterDomainType; };
