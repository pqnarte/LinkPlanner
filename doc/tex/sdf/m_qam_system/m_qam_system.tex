...
\hline
\multicolumn{5}{|c|}{ \textbf{Source Files} } \\
\hline
...
%pulse\_shaper.cpp                  &                   & \checkmark & 20180118 & \checkmark \\ \hline
...
\begin{table}[H]
    ...
    \begin{tabulary}{1.0\textwidth}{|p{6cm}|p{3.5cm}|p{1cm}||p{1.5cm}||p{1cm}|}
        \hline
        \multicolumn{5}{|c|}{ \textbf{Header Files} } \\
        \hline
        \textbf{File}                      & \textbf{Comments} &  \textbf{Help} & \textbf{timetag} & \textbf{Status} \\ \hline
...
\begin{figure}[h]
	\centering
	\includegraphics[clip, trim=2cm 6cm 2cm 6cm, width=0.7\textwidth]{./sdf/m_qam_system/figures/BER_QPSK_sim_20180123.pdf}
