...
The optimal BER that can be obtained by using matched filtering is described by:
...
\begin{table}[H]
    ...
    \begin{tabulary}{1.0\textwidth}{|p{7.5cm}|p{5.5cm}|p{1cm}|}
        ...
        homodyne\_receiver\_20180118.cpp             & $^{1,2}$			 & \checkmark \\ \hline
    ...
    \caption{$^1$ The help entry is under a different name, \textit{m\_qam\_receiver}. \label{tab:sources}}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabulary}{1.0\textwidth}{|p{7cm}|p{6cm}|p{1cm}|}
        ...
        bit\_error\_rate\_20171810.h               & $^{3}$            & \checkmark \\ \hline
        decoder\_20180118.h                        &                   & \checkmark \\ \hline
        discrete\_to\_continuous\_time\_20180118.h &                   & \checkmark \\ \hline
        homodyne\_receiver\_20171203.h             & $^{1,2,3}$        & \checkmark \\ \hline
        ...
        sampler\_20171119.h                        & $^3$              & \checkmark \\ \hline
    ...
    \end{tabulary}
    \caption{$^1$ This file does not share the same time-tag as the corresponding ".cpp" file.\\$^2$ The help entry is under a different name, \textit{m\_qam\_receiver}\label{tab:headers}}
\end{table}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{./sdf/m_qam_system/figures/mqamExperimental20180206.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[clip, trim=4cm 8cm 4cm 8cm, width=0.8\textwidth]{./sdf/m_qam_system/figures/BER_QPSK_sim_mf_20180205.pdf}
