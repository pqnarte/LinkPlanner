...
int main() {
	...
	TimeContinuousAmplitudeContinuousComplex S5{"S5.sgn"};// Hilbert filter
	...
	HilbertTransform B6{ vector<Signal*> { &S4 }, vector<Signal*> { &S5 } };
	B6.setSeeBeginningOfTransferFunction(false);
	B6.setTransferFunctionFrequencyLength(transferFunctionFrequencyLength);
