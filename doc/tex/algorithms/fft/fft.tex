...
%$y$ : Input complex signal\\
%$z$ : Output complex signal \\
%$m$ : {'-1' for FFT and '1' for IFFT}\\
...
\begin{center}
	\begin{tabular}{ |p{4cm}||p{6cm}|p{4cm}|   }
		\hline
		\centering \textbf{Length of data} & \textbf{Time elapsed by Optimized FFT in second}& \textbf{Time elapsed by  FFT in second}\\
		\hline
		\hline
		\centering \textbf{$2^{10}$}   & 0.011  & 0.012 \\
		\hline
		\centering \textbf{$2^{10}+1$} & 0.174  & 0.179 \\
		\hline
		\centering \textbf{$2^{15}$}   & 0.46   & 0.56 \\
		\hline
		\centering \textbf{$2^{15}+1$} & 6.575  & 6.839 \\
		\hline
		\centering \textbf{$2^{18}$}   & 4.062  & 4.2729 \\
		\hline
		\centering \textbf{$2^{18}+1$} & 60.916 & 63.024 \\
		\hline
		\centering \textbf{$2^{20}$}   & 18.246 & 19.226 \\
		\hline
		\centering \textbf{$2^{20}+1$} & 267.932 & 275.642 \\
		\hline
	\end{tabular}
\end{center}
