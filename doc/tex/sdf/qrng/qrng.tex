...
\begin{figure}[H]
    \centering
        \includegraphics[clip, trim=4cm 9cm 4cm 9cm, width=1.00\textwidth]{./sdf/qrng/figures_raw/prob0.pdf}
...
\begin{figure}[H]
    \centering
        \includegraphics[clip, trim=4cm 9cm 4cm 9cm, width=1.00\textwidth]{./sdf/qrng/figures_raw/prob1.pdf}
