...
%\vspace*{0.8cm}
\begin{itemize}
\item Beam-splitting attack - Eve removes a small part from the intensity of the original message and send the rest to bob in a no-losses channel. Eve introduces additional errors in order to make her information equal to the Bob information.
