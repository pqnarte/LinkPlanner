...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        alice_button->setStyleSheet(QStringLiteral("background-color: rgb(143, 89, 2);"));
        ...
        bob_button->setStyleSheet(QStringLiteral("background-color: rgb(143, 89, 2);"));
